...
{
Console.WriteLine("Employeedetails Id :"+EmpId);
Console.WriteLine("Employeedetails name :"+EmpName);
Console.WriteLine("Employeedetails Salary :"+ EmpSalary);
}
}
class Program
{
...
{
Employeedetails emp = new Employeedetails(1, "naresh", 311000);
