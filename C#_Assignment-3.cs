...
namespace InheritanceandPolymorphism
{
    ...
    class Employeedetails : IPrintable 
    {
        protected int EmpNo;
        ...
        public double SetSalary(double Salary)
        {
            ...
            else if (this.Salary > 10000 && this.Salary < 20000)
            {
                this.HRA = (this.Salary * 25) / 100;
                this.TA = (this.Salary * 15) / 100;
                this.DA = (this.Salary * 30) / 100;
            }
            else if (this.Salary >= 20000 && this.Salary < 25000)
            {
                this.HRA = (this.Salary * 25) / 100;
                this.TA = (this.Salary * 15) / 100;
                this.DA = (this.Salary * 30) / 100;
            }
            else if (this.Salary >= 25000 && this.Salary < 20000)
            {
                this.HRA = (this.Salary * 25) / 100;
        ...
        {
            this.PF = (this.GrossSalary * 15) / 100;
            this.TDS = (this.GrossSalary * 22) / 100;
